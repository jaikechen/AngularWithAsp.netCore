export const ApplicationName = 'AngularWithAuth';
...
let applicationPaths: ApplicationPathsType = {
  ...
  IdentityManageChangePasswordPath: '/Identity/Account/Manage/ChangePassword'
};
...
interface ApplicationPathsType {
  ...
  readonly IdentityManageChangePasswordPath: string;
}
